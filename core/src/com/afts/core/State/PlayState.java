...
public class PlayState extends State{
    ...
    protected void initialize()
    {
        ...
        this.entityManager = new EntityManager(this.camera, this.resourceHandler);

       for(int i = 0; i < 100; i++) {
           float size = MathUtils.random(30.f,90.f);
           this.entityManager.addEntity(
                   new Rock(
                           new Vector2(0, 200 * (i+1)),
...
//            this.entityManager.addEntity(
//                    new Rock(
//                            new Vector2(MathUtils.random(-200.f, 200),
//                                    MathUtils.random(100,400)),
//                            new Vector2(MathUtils.random(4.f,10.f), MathUtils.random(4.f,10.f)),
//                    this.resourceHandler.getTexture("tile")));
//        }
